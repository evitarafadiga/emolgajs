...
const TABLE = [
    createProperty(true,"Cidade de Lumiose", 2500 , 'https://cdn2.bulbagarden.net/upload/3/31/Lumiose_City.png'),
    createProperty(true,"Cidade de Pallet", 600  , 'https://cdn2.bulbagarden.net/upload/thumb/d/d3/Professor_Oaks_Laboratory.png/303px-Professor_Oaks_Laboratory.png'),
    createProperty(true,"Cidade de Cerulean", 700 , 'https://cdn2.bulbagarden.net/upload/archive/8/80/20170914155742%21Cerulean_Gym_anime.png'),
    createProperty(true,"Cidade de Lavender", 600 , 'https://cdn2.bulbagarden.net/upload/archive/3/31/20190527190651%21Lavender_Town_anime.png'),
    createProperty(true,"Cidade de Viridian", 400 , 'https://cdn2.bulbagarden.net/upload/archive/9/93/20191012113715%21Viridian_Gym_AG132.png'),
    createProperty(true,"Central Plaza", 1600, 'https://cdn2.bulbagarden.net/upload/6/69/Central_Plaza_anime.png'),
    createProperty(true,"Cidade de Castelia", 1600, 'https://cdn2.bulbagarden.net/upload/c/c3/Castelia_City_3D.png'),
    createProperty(true,"Floresta Branca", 600, 'https://cdn2.bulbagarden.net/upload/archive/a/a6/20110114045159%21Black_City_and_White_Forest.png'),
    createProperty(true,"Cidade Preta", 600, 'https://cdn2.bulbagarden.net/upload/archive/a/a6/20110114045159%21Black_City_and_White_Forest.png'),
    createProperty(true,"Teatro Musical", 2000, 'https://cdn2.bulbagarden.net/upload/archive/3/3a/20111007132448%21Musical_Theater_anime.png'),
    createProperty(true,"Complexo de Virbank", 1400, 'https://cdn2.bulbagarden.net/upload/archive/4/4a/20210114202906%21Virbank_Complex_anime.png'),
    createProperty(true,"Estúdios PokéStar", 2000, 'https://cdn2.bulbagarden.net/upload/archive/e/e8/20210114201532%21Pok%C3%A9star_Studios_anime.png'),
    createProperty(false,"Prisão", 500, 'https://i.imgur.com/2qPQUKi.png' ),
    createProperty(true,"Ginásio de Nimbasa", 3000, 'https://cdn2.bulbagarden.net/upload/f/fe/Nimbasa_Gym_anime.png'),
    ...
    createProperty(true,"Cidade de Sootopolis", 900, 'https://cdn2.bulbagarden.net/upload/thumb/a/a2/Sootopolis_City_anime.png/250px-Sootopolis_City_anime.png' ),
    createProperty(true,"Torre de Rádio Goldenrod", 1000, 'https://cdn2.bulbagarden.net/upload/thumb/f/fd/Radio_Tower_anime.png/226px-Radio_Tower_anime.png' ),
    createProperty(true,"Ginásio de Saffron", 700, 'https://cdn2.bulbagarden.net/upload/thumb/f/f8/Saffron_Gym_anime.png/200px-Saffron_Gym_anime.png' ),
    createProperty(true,"Ginásio de Pewter", 1000, 'https://cdn2.bulbagarden.net/upload/thumb/8/8a/Pewter_Gym_anime.png/267px-Pewter_Gym_anime.png' ),
    createProperty(true,"Casa do Brock", 500, 'https://cdn2.bulbagarden.net/upload/thumb/c/c7/Brock_House.png/267px-Brock_House.png'),
    createProperty(true,"Vulcão de Cinnabar", 600, 'https://cdn2.bulbagarden.net/upload/thumb/d/df/Cinnabar_Island_volcano.png/200px-Cinnabar_Island_volcano.png' ),
    createProperty(true,"Favela de Spikemuth", 300, 'https://cdn2.bulbagarden.net/upload/thumb/8/8b/Spikemuth_SwSh.png/300px-Spikemuth_SwSh.png' ),
    createProperty(true,"Casteliacone", 2200, 'https://i.imgur.com/oau75tS.png')
];
