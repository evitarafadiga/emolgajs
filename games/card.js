...
const TABLE = [
    ...
    createi("Você acaba de receber uma Arrokuda!","A Tempestade", 13, 'https://i.pinimg.com/236x/02/fb/d5/02fbd51d43ff61c3db256f0a1ccc2aec.jpg' ),
    ...
    createi("Proíba alguém de usar item por um dia","As bolhas", 17, 'https://i.pinimg.com/236x/3b/36/9e/3b369edcae41fd0200fee87d220823fc.jpg' ),
    createi("Roube 100 Tokens de alguém","A Flecha", 18, 'https://i.pinimg.com/236x/96/a1/08/96a108fe0579dfebf4ab749a9c4b24ca.jpg' ),
    createi("Queime um slot de alguém com ovo dentro ou não","O Foguento", 19, 'https://i.pinimg.com/236x/82/ae/88/82ae88f863e3fd880348109020740940.jpg' ),
    createi("Dê um Ovo Fada e um Ovo Bug a alguém","A Doce", 20, 'https://i.pinimg.com/236x/0e/5e/51/0e5e5120be1c67d2430a115ce43cea63.jpg' ),
    createi("Troque um pokémon seu por outro pokémon do mesmo tipo sem exceção","A Mudança", 21, 'https://i.pinimg.com/236x/7e/14/cd/7e14cd886b41d5e9b16f932a7c514ca1.jpg'),
    ...
    createi("Você acaba de receber uma Rapidash ou Rapidash-Galar!","O Traço", 24, 'https://i.pinimg.com/236x/fb/0e/3a/fb0e3a059573e560e12523dfaea0087d.jpg'),
    ...
    createi("Você acaba de receber um Arceus! O kingo permanecerá no Lvl 50 e impedido de usar plates ou cristais-z até o dia 13.","O Poder", 32, 'https://i.pinimg.com/236x/89/9f/16/899f16c32442b05cdad247816f9f017e.jpg'),
    ...
    createi("Desafie um treinador para uma batalha National Dex com Gmax. O vencedor recebe 500 Tokens!","A Luta", 39, 'https://i.pinimg.com/236x/d2/84/19/d284198d063a451d43177229ede49794.jpg'),
    ...
    createi("Você acaba de receber uma Diancie! Sem mega pedra.","O Brilho", 42, 'https://i.pinimg.com/236x/00/0e/e3/000ee3af5fdbb16806015c00d48857df.jpg'),
    createi("Você acaba de receber um Ovo Elétrico e um Raikou!","O Trovão", 43, 'https://i.pinimg.com/236x/b0/72/ab/b072ab8023d60b37f5fcc7727cedd286.jpg'),
    ...
    createi("Corte 100 pontos de um inimigo de maneira secreta.","A Tesoura", 55, 'https://i.pinimg.com/236x/a2/ab/76/a2ab7651fe88fdcd646407929f94dffe.jpg'),
    createi("Distribua 100 pontos para dois amigos, e receba 50 pontos.","A Lua", 56, 'https://i.pinimg.com/236x/e8/e2/dd/e8e2dd082d42d23af5479cda06035ffb.jpg'),
    createi("Escolha, no primeiro estágio, qualquer pokémon que foi descoberto antes de Hoenn e com mais de um estágio evolutivo","O Old", 57, 'https://i.pinimg.com/236x/d7/2c/53/d72c53a5d728b44048a666f7a8a2d8d0.jpg'),
